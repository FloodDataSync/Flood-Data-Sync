...
import { idlFactory } from './flooddatasync_frontend.did.js';
export { idlFactory } from './flooddatasync_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_FLOODDATASYNC_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./flooddatasync_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the flooddatasync_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./flooddatasync_frontend.did.js")._SERVICE>}
 */
export const flooddatasync_frontend = createActor(canisterId);
