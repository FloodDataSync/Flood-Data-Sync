...
import { idlFactory } from './flooddatasync_backend.did.js';
export { idlFactory } from './flooddatasync_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_FLOODDATASYNC_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./flooddatasync_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the flooddatasync_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./flooddatasync_backend.did.js")._SERVICE>}
 */
export const flooddatasync_backend = createActor(canisterId);
